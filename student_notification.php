                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
						...
						?>
							...
							<li><a href="#">Current Period: <?php echo $school_year_query_row['school_year']; ?></a></li>
						</ul>
						 <!-- end breadcrumb -->
					...
					// Fix: Check if $read_row exists before accessing its elements
					$yes = '';
					if ($read_row && isset($read_row['student_read'])) {
