                     ...
                     <div class="row-fluid">
					    <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#">Current Period: <?php echo $class_row['school_year']; ?></a> <span class="divider">/</span></li>
                            ...
                            <div class="block-content collapse in">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                              		...
                              		<?php
										...
										// Fix: Check if $row1 is not false/null before accessing array keys
										$grade = "";
										if($row1 && isset($row1['grade'])) {
											$grade = $row1['grade'];
										}
